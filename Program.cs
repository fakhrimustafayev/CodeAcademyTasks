...
namespace EmailSenderExample
{
    class Program
    {
        ...
        static async Task SendEmail()
        {
            ...
            var emailBody = GenerateEmailBody(recipientName);
        ...
        static string GenerateEmailBody(string recipientName)
        {
            var template = @"
...
<body class=""clean-body u_body"" style=""margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #f9f9f9;color: #000000"">
                          ...
                          <tr>
                            <td style=""overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;"" align=""left"">
                              ...
                              <div style=""font-size: 14px; line-height: 160%; text-align: center; word-wrap: break-word;"">
                                <p style=""font-size: 14px; line-height: 160%;""><span style=""font-size: 22px; line-height: 35.2px;"">Hi, Asger Babayev</span></p>
                          ...
                          <tr>
                            <td style=""overflow-wrap:break-word;word-break:break-word;padding:33px 55px 60px;font-family:'Cabin',sans-serif;"" align=""left"">
                              ...
                              <div style=""font-size: 14px; line-height: 160%; text-align: center; word-wrap: break-word;"">
                                ...
                                <p style=""line-height: 160%; font-size: 14px;""><span style=""font-size: 18px; line-height: 28.8px;"">Fakhri Mustafayev</span></p>
                              </div>
                          ...
                          <tr>
                            <td style=""overflow-wrap:break-word;word-break:break-word;padding:41px 55px 18px;font-family:'Cabin',sans-serif;"" align=""left"">
                              ...
                              <div style=""font-size: 14px; color: #003399; line-height: 160%; text-align: center; word-wrap: break-word;"">
                                ...
                                <p style=""font-size: 14px; line-height: 160%;""><span style=""font-size: 16px; line-height: 25.6px; color: #000000;"">+9940507840507</span></p>
  ...
  <!--[if IE]></div><![endif]-->
            ...
            var scriptObject = new { name = recipientName };
    var result = Template.Parse(template).Render(scriptObject);
